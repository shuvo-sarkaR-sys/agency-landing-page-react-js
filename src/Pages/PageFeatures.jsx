...
const handleClick4 = ()=>{
  ...
  return (
    <div> 
    <div className='text-center text-black mx-8 md:mx-[100px] xl:mx-[200px]'>
      ...
      <div className='flex flex-wrap-reverse md:flex-nowrap  p-10 rounded-2xl gap-10 bg-[#f6efe9]'>
      ...
      <div className='flex mt-14 flex-wrap-reverse md:flex-nowrap  p-10 rounded-2xl gap-10 bg-[#f6efe9]'>
     ...
     <div className='flex mt-10 flex-wrap-reverse md:flex-nowrap  p-10 rounded-2xl gap-10 bg-[#f6efe9]'>
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10 text-white">
  <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
     ...
     <div className='md:w-[700px] mt-8 xl:mt-20 mx-auto'>
      ...
      <Client/>
      <div className='my-28 flex  xl:gap-28 md:p-12 p-6 xl:p-20 xl:mx-[100px] md:mx-10 mx-5 rounded-3xl bg-[#f6efe9]'>
        <div> 
        <h1 className='xl:text-5xl md:text-3xl text-center font-bold'>Create stunning websites   that fits your needs.</h1>
        <p className='p-4 w-[220px]  rounded-lg mx-auto mt-20 text-xl text-white bg-green-600'>Try Lexend today</p>
