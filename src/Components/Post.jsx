...
const Post = () => {
  return (
    <div className=' md:px-[150px] px-10 py-[75px] bg-[#f6efe9]'>
      ...
      <button className='p-3 rounded-xl md:text-xl text-xs font-medium bg-green-600 text-white'>View all posts</button>
      </div>
